...
import com.thoughtworks.go.scm.plugin.cmd.Console;
import com.thoughtworks.go.scm.plugin.cmd.ConsoleResult;
...
public class GitCmdHelper extends GitHelper {
    ...
    public void cloneRepository() {
        ...
        CommandLine gitClone = Console.createCommand(ListUtils.toArray(args));
    ...
    public Revision getLatestRevision(String subDirectoryPath) {
        return gitLog("log", "-1", "--date=iso", "--pretty=medium", "--", subDirectoryPath).get(0);
    }
    ...
    @Override
    public List<Revision> getRevisionsSince(String revision, String subDirectoryPath) {
        return gitLog("log", String.format("%s..", revision), "--date=iso", "--pretty=medium", "--", subDirectoryPath);
    }
    ...
    public void fetch(String refSpec) {
        ...
        CommandLine gitFetch = Console.createCommand(ListUtils.toArray(args));
        runOrBomb(gitFetch);
    }
